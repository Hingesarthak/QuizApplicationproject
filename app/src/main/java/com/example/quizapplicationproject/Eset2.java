...
public class Eset2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_eset2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (selectedId1 != -1 && selectedId2 != -1 && selectedId3 != -1 && selectedId4 != -1 && selectedId5 != -1 && selectedId6 != -1 && selectedId7 != -1 && selectedId8 != -1 && selectedId9 != -1 && selectedId10 != -1  ) {
                    ...
                    Intent intent = new Intent(Eset2.this, Resulteasyset2.class);
                    ...
                    Toast.makeText(Eset2.this, "Please Attempt all Questions before continuing.", Toast.LENGTH_SHORT).show();
                }
        ...
        imageview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(Eset2.this, MainActivity2.class);
                startActivity(i);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(Eset2.this, MainActivity.class);
                startActivity(i);
            }
        });
