...
public class Resulteasyset4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_resulteasyset4);
        ...
        if ("Hat".equalsIgnoreCase(selectedOption1)) score++;
        if ("Cold".equalsIgnoreCase(selectedOption2)) score++;
        if ("Paint".equalsIgnoreCase(selectedOption3)) score++;
        if ("Tuesday".equalsIgnoreCase(selectedOption4)) score++;
        if ("Duck".equalsIgnoreCase(selectedOption5)) score++;
        if ("Green".equalsIgnoreCase(selectedOption6)) score++;
        if ("Two".equalsIgnoreCase(selectedOption7)) score++;
        if ("Skin".equalsIgnoreCase(selectedOption8)) score++;
        if ("Pen".equalsIgnoreCase(selectedOption9)) score++;
        if ("Water".equalsIgnoreCase(selectedOption10)) score++;


        Toast.makeText(Resulteasyset4.this, "You've Scored : " + score, Toast.LENGTH_LONG).show();
